...
namespace NEGUI2
{
  ...
  void Shader::init()
  {
    ...
    add_spv_from_file("POINT.VERT", "./shader/Point.vert.spv");
    add_spv_from_file("POINT.FRAG", "./shader/Point.frag.spv");
    add_spv_from_file("MESH.VERT", "./shader/Mesh.vert.spv");
    add_spv_from_file("MESH.FRAG", "./shader/Mesh.frag.spv");
  }
